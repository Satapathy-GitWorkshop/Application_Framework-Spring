...
public class BeanScope_Test2 {
	...
	public static void main(String[] args) {
		...
		//calling factory method & Checking the Scope  (PRTOTYPE)
		scope1=factory.getBean("bean1",BeanScope.class);
		System.out.println(scope1.hashCode());	
		scope2=factory.getBean("bean1",BeanScope.class);
		System.out.println(scope2.hashCode());
		scope3=factory.getBean("bean1",BeanScope.class);
