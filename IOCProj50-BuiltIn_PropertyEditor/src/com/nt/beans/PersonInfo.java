...
public class PersonInfo {
	...
	public String toString() {
		return "PersonInfo [adharNo=" + adharNo + ", pname=" + pname + ", addresses=" + Arrays.toString(addresses)
				+ ", salary=" + salary + ", countryCurrency=" + countryCurrency + ", dob=" + dob + ", javaClass="
				+ javaClass + ", javaClasses=" + Arrays.toString(javaClasses) + ", inputFile=" + inputFile + ", fbUrl="
				+ fbUrl + ", currentLocale=" + currentLocale + ", timezone=" + timezone + ", props=" + props + "]";
	}
